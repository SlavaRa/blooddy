...
package ru.avangardonline.database.battle.world {
	...
	[Event(name="addedToWorld", type="ru.avangardonline.events.database.world.BattleWorldDataEvent")]
	[Event(name="removedFromWorld", type="ru.avangardonline.events.database.world.BattleWorldDataEvent")]
