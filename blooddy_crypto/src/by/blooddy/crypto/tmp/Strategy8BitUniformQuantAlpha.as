...
package by.blooddy.crypto.tmp{
	 ...
	 * @author iiley
	 */
	public class Strategy8BitUniformQuantAlpha/*Strategy8BitMedianCutAlpha*/ extends EncodeStrategyBase{
		 ...
		 */
		public function Strategy8BitUniformQuantAlpha(colorNumber:int=256, alphaWeight:int=1){
			super();
...
class Block{
	...
	public function toString():String {
		return this.publishColor.toString( 16 )+'[' + this.maxSideLength+ ']('+(midCorner & uint(0x000000FF << this.maxSideLengthOffset)).toString(16)+')';
	}
