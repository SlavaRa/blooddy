package by.blooddy.platform.events {
	...
	public class DragEvent extends MouseEvent {
		...
		public override function clone():Event {
			return new DragEvent( super.type, super.bubbles, super.cancelable, super.localX, super.localY, super.relatedObject, super.ctrlKey, super.altKey, super.shiftKey, super.buttonDown, super.delta, this.dragSource, this.dragObject );
		}
